        ...
        <div className="min-h-screen bg-white">
            ...
            >
                ...
                <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
                    ...
                    <div className="flex items-center justify-center text-white">
                        ...
                        <span className="text-white font-semibold">Cloud Automation & DevOps</span>
                    </div>
                </div>
            </div>
            <div className="mt-16 text-center max-w-4xl mx-auto">
                ...
                <p className="text-gray-600 leading-relaxed max-w-4xl mx-auto text-lg">
                    ...
                    We provide managed services Driven by DevOps, our delivery processes bring in right set of tools and frameworks enabling continuous integration and delivery.
                </p>
            </div>
