        ...
        <div className="min-h-screen bg-white">
            ...
            >
                ...
                <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
                    ...
                    <div className="flex items-center justify-center text-white">
                        ...
                        <span className="text-white font-semibold">Data Engineering & Analytics</span>
                    </div>
                </div>
            </div>
            <div className="mt-16 text-center max-w-4xl mx-auto">
                ...
                <p className="text-gray-600 leading-relaxed max-w-4xl mx-auto text-lg">
                    ...
                    We ensure your organization has the agility needed for fast digital innovation by delivering cutting-edge solutions powered by cloud.                </p>
            </div>
            <section className="py-16 px-4 bg-gray-50">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-gray-600 mb-8 text-lg max-w-3xl mx-auto leading-relaxed">
                        ...
                        Expertise in AWS, Google Cloud Platform,
                    </p>
                    <Link
                        to="/contact-us"
