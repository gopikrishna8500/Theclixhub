        ...
        <div className="min-h-screen bg-white">
            ...
            >
                ...
                <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
                    ...
                    <div className="flex items-center justify-center text-white">
                        ...
                        <span className="text-white font-semibold">Instructor Led Multi-Cloud trainings</span>
                    </div>
                </div>
            </div>
            <div className="mt-16 text-center max-w-4xl mx-auto">
                ...
                <p className="text-gray-600 leading-relaxed max-w-4xl mx-auto text-lg">
                    ...
                    We provide Multi-Cloud trainings & Cloud managed services, both onsite instructor led and virtual online methods. We help students perform real-time cloud implementations and configurations with live deployment examples.                    </p>            </div>
            <section className="py-16 px-4 bg-gray-50">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-gray-600 mb-8 text-lg max-w-3xl mx-auto leading-relaxed">
                        ...
                        Corporate IT staff training,
                        Client onsite or offsite instructor led,
                        Virtual training and support,
                        Multi Cloud Trainings,
                        Expertise in Alibaba & Azure Cloud Platform
                    </p>
                    <Link
                        to="/contact-us"
